...
public class AuthController {
    ...
    @Operation(summary = "이메일 인증코드 발송", description = "회원가입을 위한 이메일 인증코드 발송")
    ...
    @Operation(summary = "이메일 인증코드 재발송", description = "이메일 인증코드 재발송 (1분 쿨다운)")
    ...
    @Operation(summary = "인증코드 검증", description = "이메일로 받은 인증코드 검증")
    ...
    @Operation(summary = "회원가입", description = "이메일과 비밀번호로 회원가입. 이메일 인증 필요")
    @PostMapping("/signup")
