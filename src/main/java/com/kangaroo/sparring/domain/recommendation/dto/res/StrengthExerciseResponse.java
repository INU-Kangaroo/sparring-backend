...
public class StrengthExerciseResponse {
    ...
    public static StrengthExerciseResponse of(String name, String duration, String frequency, List<String> precautions) {
        return StrengthExerciseResponse.builder()
                .name(name)
                .duration(duration)
                .frequency(frequency)
