...
public enum ErrorCode {
    ...
    AI_RECOMMENDATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "M006", "AI 식단 추천에 실패했습니다"),
    INVALID_BLOOD_PRESSURE_RANGE(HttpStatus.BAD_REQUEST, "M007", "수축기 혈압은 이완기 혈압보다 높아야 합니다"),
    INVALID_SYSTOLIC_PRESSURE(HttpStatus.BAD_REQUEST, "M008", "수축기 혈압은 50~300 mmHg 범위여야 합니다"),
    INVALID_DIASTOLIC_PRESSURE(HttpStatus.BAD_REQUEST, "M009", "이완기 혈압은 30~200 mmHg 범위여야 합니다"),
    INVALID_HEART_RATE(HttpStatus.BAD_REQUEST, "M010", "심박수는 30~250 bpm 범위여야 합니다"),
    INVALID_GLUCOSE_LEVEL(HttpStatus.BAD_REQUEST, "M011", "혈당 수치는 20~600 mg/dL 범위여야 합니다"),
    MEASUREMENT_TIME_FUTURE(HttpStatus.BAD_REQUEST, "M012", "측정 시간은 미래일 수 없습니다"),
    INSUFFICIENT_DATA_FOR_PREDICTION(HttpStatus.BAD_REQUEST, "M013", "예측을 위한 충분한 데이터가 없습니다"),
    ...
    // Log
    MEAL_LOG_NOT_FOUND(HttpStatus.NOT_FOUND, "L001", "식사 기록을 찾을 수 없습니다"),
